/* 演習11-06
 * 演習10-01で作成した人間クラスに誕生日を格納するデータメンバそれを返却するメンバ関数を追加
 * 作成日：5月22日
 * 作成者：成田修之
 */
#include<iostream>
...
Person::Person(std::string name, int y, double h, double w, double v,const Date& birth)
:fullname(name), year(y),height(h),weight(w),vision(v),birthday(birth)
{
}
